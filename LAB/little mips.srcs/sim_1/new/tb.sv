...
wire[7:0] debug0 = base1.mem_array0[0];
wire[7:0] debug1 = base1.mem_array1[0];
wire[7:0] debug2 = ext1.mem_array0[0];
wire[7:0] debug3 = ext1.mem_array1[0];
//Windows需要注意路径分隔符的转义，例如"D:\\foo\\bar.bin"
parameter BASE_RAM_INIT_FILE = "C:\\Users\\ilsk\\Downloads\\testfile.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
...
initial begin 
    ...
    force ext_ram_data = 32'hz;
    force ext_ram_addr = 20'h0159e;
    force ext_ram_ce_n = 1;
    force ext_ram_oe_n = 1;
    force ext_ram_we_n = 1;
    force ext_ram_be_n = 0;    
    #20  
    force ext_ram_data = 32'h00001234;
    force ext_ram_addr = 0;
    force ext_ram_ce_n = 0;
    force ext_ram_oe_n = 1;
    force ext_ram_we_n = 0;
    force ext_ram_be_n = 0;    
    #20
    force ext_ram_data = 32'h78787878;
    force ext_ram_addr = 1;
    force ext_ram_ce_n = 0;
    force ext_ram_oe_n = 1;
    force ext_ram_we_n = 0;
    force ext_ram_be_n = 4'he;  */
end
